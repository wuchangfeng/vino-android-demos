...
public class AnotherExpandTextView extends LinearLayout implements View.OnClickListener {
    public static final String TAG = "AnotherExpandTextView";
    ...
    public AnotherExpandTextView(Context context) {
        this(context, null);
    }

    public AnotherExpandTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnotherExpandTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        View.inflate(mContext, R.layout.another_expand_text_view, this);
        ...
        mIndicateImage.setOnClickListener(this);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.iv_arrow_more) {
            expand();
        }
    }
